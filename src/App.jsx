...
export default function LightspireAI() {
  ...
  const LINKS = {
    ...
    guestRecon: "https://www.guestrecon.com/",
           ...
           <div className={`transition-opacity duration-700 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
              <div className="text-center max-w-3xl mx-auto mb-20">
                 ...
                 <div className="flex justify-center gap-4">
                    <button onClick={() => setPage('guestrecon')} className="btn-ai btn-recon px-8 py-3 font-bold flex items-center gap-2 cursor-pointer">
